...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"bd073c18-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/wl-gantt/index.vue?vue&type=template&id=5b4aa81c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-table',{ref:"wl-gantt",staticClass:"wl-gantt",class:_vm.dateTypeClass,attrs:{"fit":_vm.fit,"size":_vm.size,"border":_vm.border,"data":_vm.selfData,"stripe":_vm.stripe,"height":_vm.height,"row-key":_vm.rowKey,"row-style":_vm.rowStyle,"cell-style":_vm.cellStyle,"max-height":_vm.maxHeight,"tree-props":_vm.selfProps,"current-row-key":_vm.rowKey,"row-class-name":_vm.rowClassName,"cell-class-name":_vm.cellClassName,"expand-row-keys":_vm.expandRowKeys,"header-row-style":_vm.headerRowStyle,"header-cell-style":_vm.headerCellStyle,"default-expand-all":_vm.defaultExpandAll,"header-row-class-name":_vm.headerRowClassName,"highlight-current-row":_vm.highlightCurrentRow,"header-cell-class-name":_vm.headerCellClassName},on:{"header-contextmenu":_vm.handleHeaderContextMenu,"selection-change":_vm.handleSelectionChange,"row-contextmenu":_vm.handleRowContextMenu,"current-change":_vm.handleCurrentChange,"cell-mouse-enter":_vm.handleMouseEnter,"cell-mouse-leave":_vm.handleMouseLeave,"expand-change":_vm.handleExpandChange,"filter-change":_vm.handleFilterChange,"cell-dblclick":_vm.handleCellDbClick,"header-click":_vm.handleHeaderClick,"row-dblclick":_vm.handleRowDbClick,"sort-change":_vm.handleSortChange,"cell-click":_vm.handleCellClick,"select-all":_vm.handleSelectAll,"row-click":_vm.handleRowClick,"select":_vm.handleSelect}},[_vm._t("prv"),_c('el-table-column',{attrs:{"fixed":"","label":"名称","min-width":"200","show-overflow-tooltip":"","prop":_vm.selfProps.name,"formatter":_vm.nameFormatter}}),_c('el-table-column',{attrs:{"resizable":false,"fixed":"","width":"160","align":"center","prop":_vm.selfProps.startDate,"label":"开始日期"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row._start_edit)?_c('el-date-picker',{ref:"wl-start-date",staticClass:"u-full",attrs:{"type":"date","size":"medium","clearable":false,"value-format":"yyyy-MM-dd","placeholder":"请选择开始日期"},on:{"blur":function($event){scope.row._start_edit = false},"change":function($event){return _vm.startDateChange(scope.row)}},model:{value:(scope.row[_vm.selfProps.startDate]),callback:function ($$v) {_vm.$set(scope.row, _vm.selfProps.startDate, $$v)},expression:"scope.row[selfProps.startDate]"}}):_c('span',{on:{"click":function($event){return _vm.cellEdit(scope.row, '_start_edit', 'wl-start-date')}}},[_vm._v(_vm._s(_vm.timeFormat(scope.row[_vm.selfProps.startDate])))])]}}])}),_c('el-table-column',{attrs:{"fixed":"","resizable":false,"width":"160","align":"center","prop":_vm.selfProps.endDate,"label":"结束日期"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row._end_edit)?_c('el-date-picker',{ref:"wl-end-date",staticClass:"u-full",attrs:{"type":"date","size":"medium","clearable":false,"value-format":"yyyy-MM-dd","placeholder":"请选择结束日期"},on:{"blur":function($event){scope.row._end_edit = false},"change":function($event){return _vm.endDateChange(scope.row)}},model:{value:(scope.row[_vm.selfProps.endDate]),callback:function ($$v) {_vm.$set(scope.row, _vm.selfProps.endDate, $$v)},expression:"scope.row[selfProps.endDate]"}}):_c('span',{on:{"click":function($event){return _vm.cellEdit(scope.row, '_end_edit', 'wl-end-date')}}},[_vm._v(_vm._s(_vm.timeFormat(scope.row[_vm.selfProps.endDate])))])]}}])}),_vm._t("default"),(_vm.self_date_type === 'yearAndMonth')?_vm._l((_vm.ganttTitleDate),function(year){return _c('el-table-column',{key:year.id,attrs:{"resizable":false,"label":year.name}},_vm._l((year.children),function(month){return _c('el-table-column',{key:month.id,attrs:{"class-name":"wl-gantt-item","resizable":false,"label":month.name},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('div',{class:_vm.dayGanttType(scope.row, month.full_date, 'months')})]}}],null,true)})}),1)}):(_vm.self_date_type === 'yearAndWeek')?_vm._l((_vm.ganttTitleDate),function(i){return _c('el-table-column',{key:i.id,attrs:{"resizable":false,"label":i.full_date}},_vm._l((i.children),function(t){return _c('el-table-column',{key:t.id,attrs:{"class-name":"wl-gantt-item","resizable":false,"label":t.name},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('div',{class:_vm.dayGanttType(scope.row, t.full_date, 'week')})]}}],null,true)})}),1)}):_vm._l((_vm.ganttTitleDate),function(i){return _c('el-table-column',{key:i.id,attrs:{"resizable":false,"label":i.full_date}},_vm._l((i.children),function(t){return _c('el-table-column',{key:t.id,attrs:{"class-name":"wl-gantt-item","resizable":false,"label":t.name},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('div',{class:_vm.dayGanttType(scope.row, t.full_date)})]}}],null,true)})}),1)})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/wl-gantt/index.vue?vue&type=template&id=5b4aa81c&
...
/* harmony default export */ var wl_ganttvue_type_script_lang_js_ = ({
  ...
  methods: {
     ...
     */
    cellEdit: function cellEdit(row, key, ref) {
      var _this = this;
    ...
    emitTimeChange: function emitTimeChange(item) {
      ...
      this.$nextTick(function () {
        _this2.$set(item, "_oldStartDate", item[_this2.selfProps.startDate]);

        _this2.$set(item, "_oldEndDate", item[_this2.selfProps.endDate]);
      });
    },
    // 处理外部数据 ---------------------------------------------------------------原始数据处理-------------------------------------
    handleData: function handleData(data) {
      ...
      data.forEach(function (i) {
        _this3.$set(i, "_parent", parent); // 添加父级字段


        _this3.$set(i, "_level", level); // 添加层级字段


        if (!i._oldStartDate) {
          _this3.$set(i, "_oldStartDate", i[_this3.selfProps.startDate]);
        }

        if (!i._oldEndDate) {
          _this3.$set(i, "_oldEndDate", i[_this3.selfProps.endDate]);
        } // 当结束时间早于开始时间时，自动处理结束时间为开始时间延后一天


        var _end_early_start = _this3.timeIsBefore(i[_this3.selfProps.endDate], i[_this3.selfProps.startDate]);

        if (_end_early_start) {
          _this3.$set(i, _this3.selfProps.endDate, i[_this3.selfProps.startDate]);

          _this3.$set(i, "_cycle", 1); // 添加工期字段


          _this3.emitTimeChange(i); // 将发生时间更新的数据输出

        } else {
          var _time_diff = _this3.timeDiffTime(i[_this3.selfProps.startDate], i[_this3.selfProps.endDate]);

          _this3.$set(i, "_cycle", _time_diff + 1); // 添加工期字段

        } // 添加工期字段
        // 如果当前节点的开始时间早于父节点的开始时间，则将开始时间与父节点相同


        _this3.parentStartDateToChild(i); // 校验结束时间是否晚于子节点，如不则将节点结束时间改为最晚子节点


        _this3.childEndDateToParent(i); // 添加自增id字段及树链组成的parents字段


        _this3.recordIdentityIdAndParents(i);

        if (Array.isArray(i[_this3.selfProps.children])) {
          _this3.$set(i, "_isLeaf", false); // 添加是否叶子节点字段


          var _all_children = flattenDeep(i[_this3.selfProps.children], _this3.selfProps.children);

          _this3.$set(i, "_all_children", _all_children); // 添加全部子节点字段


          _this3.handleData(i[_this3.selfProps.children], i, level);
        } else {
          _this3.$set(i, "_isLeaf", true); // 添加是否叶子节点字段


          _this3.$set(i, "_all_children", []); // 添加全部子节点字段

        } // 处理前置任务


        _this3.handlePreTask(i);

        if (!i.hasOwnProperty("_start_edit")) {
          // 添加编辑字段管理可编辑项的显示
          _this3.$set(i, "_start_edit", false);

          _this3.$set(i, "_end_edit", false);
        }
      });
    },
    ...
    handlePreTask: function handlePreTask(item) {
      ...
      var _pre_target = this.self_data_list.find(function (i) {
        return i[_this4.selfProps.id] == item[_this4.selfProps.pre];
      });
    ...
    terseHandleData: function terseHandleData(data) {
      ...
      level++;
      data.forEach(function (i) {
        _this5.$set(i, "_parent", parent); // 添加父级字段


        _this5.$set(i, "_level", level); // 添加层级字段


        var _time_diff = _this5.timeDiffTime(i[_this5.selfProps.startDate], i[_this5.selfProps.endDate]);

        i._cycle = _time_diff + 1;

        if (!i._oldStartDate) {
          // 添加开始时间字段
          _this5.$set(i, "_oldStartDate", i[_this5.selfProps.startDate]);
        }

        if (!i._oldEndDate) {
          // 添加结束字段时间
          _this5.$set(i, "_oldEndDate", i[_this5.selfProps.endDate]);
        } // 添加自增id字段及树链组成的parents字段


        _this5.recordIdentityIdAndParents(i);

        if (Array.isArray(i[_this5.selfProps.children])) {
          _this5.$set(i, "_isLeaf", false); // 添加是否叶子节点字段


          var _all_children = flattenDeep(i[_this5.selfProps.children], _this5.selfProps.children);

          _this5.$set(i, "_all_children", _all_children); // 添加全部子节点字段


          _this5.terseHandleData(i[_this5.selfProps.children], i, level);
        } else {
          _this5.$set(i, "_isLeaf", true); // 添加是否叶子节点字段

        } // 处理前置任务


        _this5.handlePreTask(i);

        if (!i.hasOwnProperty("_start_edit")) {
          // 添加编辑字段管理可编辑项的显示
          _this5.$set(i, "_start_edit", false);

          _this5.$set(i, "_end_edit", false);
        }
      });
    },
