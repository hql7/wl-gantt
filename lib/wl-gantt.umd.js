...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"bd073c18-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/wl-gantt/index.vue?vue&type=template&id=3b95db1c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-table',{ref:"wl-gantt",staticClass:"wl-gantt",class:_vm.dateTypeClass,attrs:{"border":"","row-key":"id","current-row-key":"id","default-expand-all":"","data":_vm.selfData,"tree-props":_vm.selfProps,"header-row-class-name":"wl-gantt-header"}},[_c('el-table-column',{attrs:{"resizable":false,"fixed":"","prop":_vm.selfProps.name,"width":"160","label":"名称"}}),_c('el-table-column',{attrs:{"resizable":false,"fixed":"","width":"160","prop":_vm.selfProps.startDate,"label":"开始日期"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('el-date-picker',{staticClass:"u-full",attrs:{"type":"date","size":"medium","clearable":false,"value-format":"yyyy-MM-dd","placeholder":"请选择开始日期"},on:{"change":function($event){return _vm.startDateChange(scope.row)}},model:{value:(scope.row[_vm.selfProps.startDate]),callback:function ($$v) {_vm.$set(scope.row, _vm.selfProps.startDate, $$v)},expression:"scope.row[selfProps.startDate]"}})]}}])}),_c('el-table-column',{attrs:{"fixed":"","resizable":false,"width":"160","prop":_vm.selfProps.endDate,"label":"结束日期"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('el-date-picker',{staticClass:"u-full",attrs:{"type":"date","size":"medium","clearable":false,"value-format":"yyyy-MM-dd","placeholder":"请选择结束日期"},on:{"change":function($event){return _vm.endDateChange(scope.row, 'end')}},model:{value:(scope.row[_vm.selfProps.endDate]),callback:function ($$v) {_vm.$set(scope.row, _vm.selfProps.endDate, $$v)},expression:"scope.row[selfProps.endDate]"}})]}}])}),_vm._t("default"),_vm._l((_vm.titleDate),function(year){return _c('el-table-column',{key:year.id,attrs:{"resizable":false,"label":year.name}},_vm._l((year.children),function(month){return _c('el-table-column',{key:month.id,attrs:{"class-name":"wl-gantt-item","resizable":false,"label":month.name},scopedSlots:_vm._u([{key:"default",fn:function(scope){return (_vm.dateType === 'yearAndMonth')?[_c('div',{class:_vm.dayGanttType(scope.row, month.full_date, 'months')})]:undefined}}],null,true)})}),1)})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/wl-gantt/index.vue?vue&type=template&id=3b95db1c&
...
// CONCATENATED MODULE: ./src/assets/array.js
/**
 * @Author: jianglei
...
function treeToArray(data, children) {
  ...
  Array.from(data).forEach(function (record) {
    ...
    var _parents = parent ? parent._parents + record.id : record.id;
    ...
    if (record[children] && record[children].length > 0) {
      var childs = treeToArray(record[children], children, record, _level); // tmp = tmp.concat(childs);
    }
  });
  return tmp;
}
...
/* harmony default export */ var wl_ganttvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    titleDate: function titleDate() {
      ...
      var start_day = Number(start_date_spilt[2]);
      var end_year = Number(end_date_spilt[0]);
      var end_mouth = Number(end_date_spilt[1]);
      var end_day = Number(end_date_spilt[2]); // 日期数据盒子
      ...
      if (year_diff === 0) {
        ...
        var isLeap = this.isLeap(start_year);

        for (var i = start_mouth; i < end_mouth + 1; i++) {
          var days = this.generationDays(start_year, i, isLeap);
          mouths.push({
            name: "".concat(i, "\u6708"),
            date: i,
            full_date: "".concat(start_year, "-").concat(i),
            id: uuidv4(),
            children: days
          });
        }
      ...
      for (var _i = start_mouth; _i < 13; _i++) {
        var _days = this.generationDays(start_year, _i, startIsLeap);

        start_mouths.push({
          name: "".concat(_i, "\u6708"),
          date: _i,
          full_date: "".concat(start_year, "-").concat(_i),
          id: uuidv4(),
          children: _days
        });
      } // 处理结束月份
      ...
      for (var _i2 = 1; _i2 < end_mouth + 1; _i2++) {
        var _days2 = this.generationDays(end_year, _i2, endIsLeap);

        end_mouths.push({
          name: "".concat(_i2, "\u6708"),
          date: _i2,
          full_date: "".concat(end_year, "-").concat(_i2),
          id: uuidv4(),
          children: _days2
        });
      } // 年间隔等于一年
      ...
      if (year_diff > 1) {
        for (var _i3 = 1; _i3 < year_diff; _i3++) {
          var _item_year = start_year + _i3;

          var _isLeap = this.isLeap(_item_year);

          var month_and_day = this.generationMonths(_item_year, _isLeap);
          dates.push({
  ...
  methods: {
     ...
     * row: object 当前行数据
     */
    endDateChange: function endDateChange(row) {// 如果开始晚于结束，提示
     ...
     * isLeap: boolean 是否闰年
     */
    generationMonths: function generationMonths(year, isLeap) {
      var months = [];

      for (var i = 1; i < 13; i++) {
        var days = this.generationDays(year, i, isLeap);
        months.push({
          name: "".concat(i, "\u6708"),
          date: i,
     ...
     * isLeap: boolean 是否闰年
     */
    generationDays: function generationDays(year, month, isLeap) {
    ...
    emitTimeChange: function emitTimeChange(item) {
      ...
      this.$nextTick(function () {
        _this.$set(item, "_oldStartDate", item[_this.selfProps.startDate]);

        _this.$set(item, "_oldEndDate", item[_this.selfProps.endDate]);
      });
    },
    // 处理外部数据 ---------------------------------------------------------------原始数据处理-------------------------------------
    handleData: function handleData(data) {
      ...
      data.forEach(function (i) {
        _this2.$set(i, "_parent", parent); // 添加父级字段


        _this2.$set(i, "_level", level); // 添加层级字段


        if (!i._oldStartDate) {
          _this2.$set(i, "_oldStartDate", i[_this2.selfProps.startDate]);
        }

        if (!i._oldEndDate) {
          _this2.$set(i, "_oldEndDate", i[_this2.selfProps.endDate]);
        } // 当结束时间早于开始时间时，自动处理结束时间为开始时间延后一天


        var _end_early_start = _this2.timeIsBefore(i[_this2.selfProps.endDate], i[_this2.selfProps.startDate]);

        if (_end_early_start) {
          _this2.$set(i, _this2.selfProps.endDate, i[_this2.selfProps.startDate]);

          _this2.$set(i, "_cycle", 1); // 添加工期字段


          _this2.emitTimeChange(i); // 将发生时间更新的数据输出

        } else {
          var _time_diff = _this2.timeDiffTime(i[_this2.selfProps.startDate], i[_this2.selfProps.endDate]);

          _this2.$set(i, "_cycle", _time_diff + 1); // 添加工期字段

        } // 添加工期字段
        // 如果当前节点的开始时间早于父节点的开始时间，则将开始时间与父节点相同


        _this2.parentStartDateToChild(i); // 校验结束时间是否晚于子节点，如不则将节点结束时间改为最晚子节点


        _this2.childEndDateToParent(i); // 添加自增id字段及树链组成的parents字段


        _this2.recordIdentityIdAndParents(i);

        if (Array.isArray(i[_this2.selfProps.children])) {
          _this2.$set(i, "_isLeaf", false); // 添加是否叶子节点字段


          var _all_children = flattenDeep(i[_this2.selfProps.children], _this2.selfProps.children);

          _this2.$set(i, "_all_children", _all_children); // 添加全部子节点字段


          _this2.handleData(i[_this2.selfProps.children], i, level);
        } else {
          _this2.$set(i, "_isLeaf", true); // 添加是否叶子节点字段


          _this2.$set(i, "_all_children", []); // 添加全部子节点字段

        } // 处理前置任务


        _this2.handlePreTask(i);
      });
    },
    ...
    handlePreTask: function handlePreTask(item) {
      ...
      if (!item[this.selfProps.pre]) return; // 找到前置目标节点

      var _pre_target = this.self_data_list.find(function (i) {
        return i[_this3.selfProps.id] == item[_this3.selfProps.pre];
      });

      if (!_pre_target) return;
      var is_pre_standard = this.targetInParentsOrChildren(item, _pre_target);
      if (is_pre_standard) return; // 查看是否需要根据前置时间，如果不符合规则，更新后置时间

      var _start_early_prvend = this.timeIsBefore(item[this.selfProps.startDate], _pre_target[this.selfProps.endDate]);

      if (_start_early_prvend) {
        var _cycle = item._cycle - 1;

        var _to_startDate = this.timeAdd(_pre_target[this.selfProps.endDate], 1);
    ...
    terseHandleData: function terseHandleData(data) {
      ...
      level++;
      data.forEach(function (i) {
        _this4.$set(i, "_parent", parent); // 添加父级字段


        _this4.$set(i, "_level", level); // 添加层级字段


        var _time_diff = _this4.timeDiffTime(i[_this4.selfProps.startDate], i[_this4.selfProps.endDate]);

        i._cycle = _time_diff + 1;

        if (!i._oldStartDate) {
          // 添加开始时间字段
          _this4.$set(i, "_oldStartDate", i[_this4.selfProps.startDate]);
        }

        if (!i._oldEndDate) {
          // 添加结束字段时间
          _this4.$set(i, "_oldEndDate", i[_this4.selfProps.endDate]);
        } // 添加自增id字段及树链组成的parents字段


        _this4.recordIdentityIdAndParents(i);

        if (Array.isArray(i[_this4.selfProps.children])) {
          _this4.$set(i, "_isLeaf", false); // 添加是否叶子节点字段


          var _all_children = flattenDeep(i[_this4.selfProps.children], _this4.selfProps.children);

          _this4.$set(i, "_all_children", _all_children); // 添加全部子节点字段


          _this4.terseHandleData(i[_this4.selfProps.children], i, level);
        } else {
          _this4.$set(i, "_isLeaf", true); // 添加是否叶子节点字段

        } // 处理前置任务


        _this4.handlePreTask(i);
      });
    }
  },
  watch: {
